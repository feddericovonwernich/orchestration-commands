...
3. Pass goal/context, approved plan text, max loops 3, and commit mode ON/OFF to the subagent.
...
7. On `APPROVE`, call subagent `orchestrator-loop` with the approved plan, max loops 3, and commit mode ON/OFF.
